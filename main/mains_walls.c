...
// /*   Updated: 2026/03/04 16:13:33 by dinza-cr         ###   ########.fr       */
// /*                                                                            */
// /* ************************************************************************** */
...
//     t_shape *temp = world->shapes;

//     temp->transformation = trsf_scaling(10, 0.01, 10);
//     temp->inv_transfo = mop_inverse(temp->transformation);
//     temp->material.color = cons_color(1, 0.9, 0.9);
//     temp->material.specular = 0;

//     temp = temp->next;
    
//     temp->transformation = mop_multimat(trsf_translation(0,0,5),
